...
UIINABOX_API inline uiBox top_left_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox top_center_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox top_right_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox center_left_ui( uiStyle const* style, uiBox box )
{
...
#define center_ui_( Box )                                                      \
   center_ui( NULL, (Box) )
UIINABOX_API inline uiBox center_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox center_right_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox bottom_left_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox bottom_center_ui( uiStyle const* style, uiBox box )
{
...
UIINABOX_API inline uiBox bottom_right_ui( uiStyle const* style, uiBox box )
{
